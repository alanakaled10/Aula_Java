...
public class App {
    public static void main(String[] args) {
        ...
        System.out.println("Equals - >" + produto1.equals(produto2)); // true
        System.out.println("Equals - >" + produto1.equals(produto3)); // false
        ...
        System.out.println("Equals - >" + livro1.equals(livro2)); // true
        System.out.println("Equals - >" + livro1.equals(livro3)); // false
        ...
        System.out.println("Equals - >" + dvd1.equals(dvd2)); // true
        System.out.println("Equals - >" + dvd1.equals(dvd3)); // false
    }
